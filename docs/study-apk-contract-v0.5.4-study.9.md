...
Generated: 2026-07-19T19:59:55.9259779+08:00
...
| release health writes UTF-8 without BOM | OK | UTF-8 no BOM writer |
...
| release provenance gates unique subject URIs | OK | subject URI uniqueness |
| release provenance gates release-tag subject URIs | OK | subject URI release tag |
| release provenance gates GitHub HTTPS subject URIs | OK | subject URI GitHub HTTPS |
| release provenance gates decoded subject URI filenames | OK | subject URI filename match |
| study contract requires decoded provenance URI filenames | OK | required provenance gate |
| release provenance gates positive subject sizes | OK | subject size gate |
| release provenance gates canonical subject SHA-256 | OK | subject digest format |
...
| release asset manifest gates non-empty asset names | OK | asset name presence |
| release asset manifest gates unique asset names | OK | asset name uniqueness |
| release asset manifest gates non-empty asset URLs | OK | asset URL presence |
| release asset manifest gates unique asset URLs | OK | asset URL uniqueness |
| release asset manifest gates positive asset sizes | OK | asset size gate |
| release asset manifest gates uploaded assets | OK | asset upload state gate |
| release asset manifest gates canonical asset digests | OK | asset digest gate |
| release asset manifest gates release-tag asset URLs | OK | asset URL tag gate |
| release asset manifest gates GitHub HTTPS asset URLs | OK | GitHub HTTPS asset URL gate |
| release asset manifest gates decoded asset URL filenames | OK | asset URL filename match |
...
| release evidence contract asserts JSON tag format | OK | JSON tag format |
...
| release evidence contract asserts boolean check ok values | OK | check ok value type |
| release evidence contract asserts string check details | OK | check detail type |
| release evidence contract asserts string check names | OK | check name type |
...
| release asset manifest gate passes: release asset URLs are unique | OK | assets=5, duplicates=0 |
| release asset manifest gate passes: all release assets have positive sizes | OK | assets=5, invalid=0 |
...
| release provenance gate passes: subject URIs are unique | OK | subjects=2, duplicates=0 |
| release provenance gate passes: all subjects match release tag asset URIs | OK | subjects=2, invalid=0; tag=v0.5.4-study.9 |
| release provenance gate passes: all subjects use GitHub HTTPS release downloads | OK | subjects=2, invalid=0; prefix=https://github.com/GravityblueX/YumeBox-MaterialDesign-Study/releases/download/v0.5.4-study.9/ |
...
| release provenance timestamps parse | OK | generated=07/19/2026 13:47:34, started=07/19/2026 13:47:25, finished=07/19/2026 13:47:34 |
| release provenance timeline is ordered | OK | started=07/19/2026 13:47:25 +08:00, generated=07/19/2026 13:47:34 +08:00, finished=07/19/2026 13:47:34 +08:00 |
...
| release provenance material digest matches release asset manifest | OK | recorded=f108b2c94ebd2ff12715d92182adc4edd8fa3b460be726851f29cda273a5ffda, actual=f108b2c94ebd2ff12715d92182adc4edd8fa3b460be726851f29cda273a5ffda |
...
| study contract check ok values are boolean | OK | nonBoolean=0 |
| study contract check details are strings | OK | nonString=0 |
| study contract check names are strings | OK | nonString=0 |
| study contract check names are unique | OK | 352 check name(s) |
